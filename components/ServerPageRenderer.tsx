...
export default async function ServerPageRenderer({ slug, locale = 'en', cars = [] }: ServerPageRendererProps) {
  ...
  try {
    ...
    // If page doesn't exist in CMS yet, return null to use fallback
    page = null;
  }

  // If page doesn't exist in CMS or is not published, return null to use fallback
